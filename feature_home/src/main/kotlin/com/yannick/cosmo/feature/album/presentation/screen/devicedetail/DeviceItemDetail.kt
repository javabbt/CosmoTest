    ...
    ElevatedCard(
        ...
        Row(
            ...
            Column(
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text =  stringResource(id = R.string.light_auto, deviceUiModel.lightAuto ?: false),
                    modifier = Modifier.fillMaxWidth(),
                    textAlign = TextAlign.End,
                    fontSize = 14.sp,
                )
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text =  stringResource(id = R.string.light_mode, deviceUiModel.lightMode ?: "-"),
                    modifier = Modifier.fillMaxWidth(),
                    textAlign = TextAlign.End,
                    fontSize = 14.sp,
                )
                ...
                Spacer(modifier = Modifier.height(8.dp))
                Text(
                    text =  stringResource(id = R.string.light_val, deviceUiModel.lightValue ?: 0),
                    modifier = Modifier.fillMaxWidth(),
                    textAlign = TextAlign.End,
                    fontSize = 14.sp,
                )
